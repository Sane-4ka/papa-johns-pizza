  ...
  return (
    <div className="nav-left-logo">
      <Link to="/" className="logo-link">
        <img
          src="https://upload.wikimedia.org/wikipedia/ru/thumb/c/c4/Papa_John%27s_Pizza_logo.svg/1200px-Papa_John%27s_Pizza_logo.svg.png"
          alt=""
        />
      </Link>
    </div>
  ...
  return (
    <div className="nav">
      <ul className="nav-list">
        ...
        <li className="nav-item">
          <Link to="/papa-bonus" className="nav-link">
            Papa Bonus
          </Link>
        </li>
        <li className="nav-item">
